    ...
    <PrivacyPolicy as={Container}>
      ...
      <ol type="1">
        <li>
          Background
          <p>
            Machnet Technologies Inc. (MACHNET) provides a Unified Software
            ...
            as the “Services”), as well as our Agreements, describes our roles
            as a “Data Controller” of such data. By visiting, interacting with
            our Platform, and/or accessing or using any of our Services, you
            agree that MACHNET can use such data in accordance with our privacy
        ...
        <li>
          ...
          <ul type="disc">
            <li>
              ...
              telephone, online at your Website, through paper-based forms, or
              at your agent locations. This personal information may include
            ...
            <li>
              ...
              the user’s bank account verification. Such bank account
              verification is completed by the services such as, but not limited
              to, Plaid Inc in accordance with Plaid Inc’s end-user Privacy
              Policy (Available at www.plaid.com/legal ). However, in case the
              ...
              is directly collected and held by third-party service providers.
            </li>
            <li>
        ...
        <li>
          ...
          <ul type="disc">
            ...
            <li>
              Using user and transaction information as an input mechanism to
              ...
              transaction attempts in the future.
            </li>
          </ul>
        </li>
        <li>
          ...
          <ul type="disc">
            ...
            <li>
              ...
              and service providers, for example, lawful requirements to
              disclose personal information to government authorities in those
              countries.
            </li>
            <li>
              ...
              disposals of all or part of our business or assets (including, for
        ...
        <li>
          ...
          <p>
            ...
            perform another transaction during the fixed time period, the user’s
