...
export const usecases = [
  ...
  {   
    ...
    icon: Bank,
    height: '300px',
    api:'https://carbon.now.sh/embed?bg=rgba(55%2C58%2C89%2C0)&t=blackboard&wt=none&l=javascript&ds=true&dsyoff=0px&dsblur=50px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=4x&wm=false&code=curl%2520-X%2520GET%2520https%253A%252F%252Fsandbox.machpay.com%252Fv2%252Fsenders%252Ffunding-sources%2520%255C%250A%2520%2520-H%2520%27Accept%253A%2520application%252Fjson%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Id%253A%2520clientid%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Secret%253A%2520clientsecret%27'
  },
  {
