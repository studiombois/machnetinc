...
export const usecases = [
  {
    ...
    icon: UserVerified,
    api:'https://carbon.now.sh/embed?bg=rgba(171%2C184%2C195%2C0)&t=blackboard&wt=none&l=auto&ds=true&dsyoff=0px&dsblur=6px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=11px&lh=133%25&si=false&es=2x&wm=false&code=curl%2520-X%2520POST%2520https%253A%252F%252Fsandbox.api.machpay.com%252Fv2%252Fsenders%2520%255C%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%250A%2520%2520-H%2520%27Accept%253A%2520application%252Fjson%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Id%253A%2520clientid%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Secret%253A%2520clientsecret%27%2520%255C%250A%2520%2520-d%2520%257B%2520%255C%250A%2520%2520%2520%2520%2520%2520%2522first_name%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2520%2520%2522middle_name%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2520%2520%2522last_name%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2520%2520%2522mobile_phone%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2520%2520%2522email%2522%253A%2520%2522user%2540example.com%2522%252C%2520%255C%250A%2520%2520%2520%2520%2520%2520%2522state%2522%253A%2520%2522string%2522%2520%255C%250A%2520%2520%257D%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A'
  },
  { 
    title:'Add Payment',
    description: 'Instant Account Verification',
    icon: Bank,
    api:'https://carbon.now.sh/embed?bg=rgba(171%2C184%2C195%2C0)&t=blackboard&wt=none&l=auto&ds=true&dsyoff=0px&dsblur=6px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=11px&lh=133%25&si=false&es=2x&wm=false&code=curl%2520-X%2520GET%2520https%253A%252F%252Fsandbox.api.machpay.com%252Fv2%252Fsenders%252Ffunding-sources%2520%255C%250A%2520%2520-H%2520%27Accept%253A%2520application%252Fjson%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Id%253A%2520clientid%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Secret%253A%2520clientsecret%27%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A%250A'
  },
  {
    title:'Add Beneficiary',
    description: 'Disbursement across Machnet’s global network',
    icon: Users,
    api:'https://carbon.now.sh/embed?bg=rgba(171%2C184%2C195%2C0)&t=blackboard&wt=none&l=auto&ds=true&dsyoff=0px&dsblur=6px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=11px&lh=133%25&si=false&es=2x&wm=false&code=curl%2520-X%2520POST%2520https%253A%252F%252Fsandbox.api.machpay.com%252Fv2%252Fsenders%252F%257BsenderId%257D%252Frecipients%250A%2520%2520%255C%250A%2520%2520-H%2520%27Accept%253A%2520application%252Fjson%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Id%253A%2520clientid%27%2520%255C%250A%2520%2520-H%2520%27X-Client-Secret%253A%2520clientsecret%27%2520%255C%250A%2520%2520-d%2520%257B%2520%255C%250A%2520%2520%2520%2520%2522first_name%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522last_name%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522country%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522address_line1%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522city%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522postal_code%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522province%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522email%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%2520%2520%2522mobile_phone%2522%253A%2520%2522string%2522%252C%2520%255C%250A%2520%2520%257D%250A%250A%250A%250A%250A%250A'
  },
  {
